...
public class UpdateAdminInfo extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            PreparedStatement statement = connected.prepareStatement("Update Admin set Username='" + jTextField1.getText() + "',Password='"+jTextField2.getText()+"' where Username='"+UserName+"'");
            statement.execute();
            this.dispose();
            Login.main(null);
